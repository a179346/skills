...
- 如果使用者有提出問題或改善的地方，視情況回到步驟 2 或步驟 3（仍在 plan mode 中）
- 如果使用者同意，使用 `ExitPlanMode` 離開 plan mode，進入下一階段
...
**列出候選 skills 問使用者要用哪些來 review**，使用者確認後，直接呼叫選中的 skill 來 review implementation。
